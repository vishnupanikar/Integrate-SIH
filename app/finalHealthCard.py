...
def getZoneWiseQuestions():
    Surveryforms=fetchSurveyData()
...
def getHealthParameters():
    HealthParameters=getZoneWiseQuestions()
...
def getHealthValues():
    ...
    HealthParameters=getHealthParameters()
...
for hv in healthvalues:
    print("ZoneName:"+hv[0])
    for i in range(1,16):
        print("\n {} \n {}".format(hv[i][0],hv[i][1]))"""